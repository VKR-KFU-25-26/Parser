...
public class RegionJobService : IRegionJobService
{
    ...
    {
        _logger.LogInformation("Запущена задача для региона: {Region}", regionName);
        ...
        try
        {
            ...
            _logger.LogInformation("Регион {Region} относится к {District}", regionName, federalDistrict);
